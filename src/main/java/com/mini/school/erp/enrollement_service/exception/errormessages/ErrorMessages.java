package com.mini.school.erp.enrollement_service.exception.errormessages;

public class ErrorMessages {

    public static final String ENROLLMENT_NOT_FOUND = "Enrollment not found for studentId";
